...
(function (Analytics) {
    var Client = /** @class */ (function () {
         ...
         * IDFA on their own.
         */
        Client.prototype.setIDFA = function (idfa) {
            bridge_1.default.setIDFA(idfa);
        };
        /**
        ...
        Client.prototype.track = function (event, properties, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.middlewares.run('track', { event: event, properties: properties, integrations: options.integrations || {} }, options.context || {})];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        Client.prototype.screen = function (name, properties, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.middlewares.run('screen', { name: name, properties: properties, integrations: options.integrations || {} }, options.context || {})];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        Client.prototype.identify = function (user, traits, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.middlewares.run('identify', { user: user, traits: traits, options: options, integrations: options.integrations || {} }, options.context || {})];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        Client.prototype.group = function (groupId, traits, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.middlewares.run('group', { groupId: groupId, traits: traits, integrations: options.integrations || {} }, options.context || {})];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
        ...
        Client.prototype.alias = function (newId, options) {
            ...
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.middlewares.run('alias', { newId: newId, integrations: options.integrations || {} }, options.context || {})];
                        case 1:
                            _a.sent();
                            return [2 /*return*/];
                    }
